 export default function GridOutlines() {
    return (
        <div className="absolute flex justify-center w-full pointer-events-none z-50">
            <div className="hidden sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-3 px-4 h-screen w-full max-w-7xl">
